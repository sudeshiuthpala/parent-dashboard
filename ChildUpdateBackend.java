...
public class ChildUpdateBackend extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    ChildUpdateBackend(Context ctx){
        context=ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String update_url="http://192.168.1.102/childUpdate.php";
